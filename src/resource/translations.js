    ...
    en: {
      ...
      about: {
        ...
        workExperience: [
          ...
          {years: '2019', company:'Titansoft', jobtitle: 'Technical Consultant', jobsummary:'RESTful API,Payment Systems', location:['Taiwan']},
    ...
    jp: {
      ...
      about: {
        ...
        workExperience: [
          ...
          {years: '2019', company:'Titansoft', jobtitle: '技術コンサルタント', jobsummary:'RESTful API,Payment Systems', location:['Taiwan']},
